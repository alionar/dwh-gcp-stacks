...
create_movies_media = BigQueryOperator(
    ...
    use_legacy_sql = False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_media.sql').read().replace("\n"," "),
...
create_movies_collection_lists = BigQueryOperator(
    ...
    use_legacy_sql = False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_collection_lists.sql').read().replace("\n"," "),
...
create_movies_genres = BigQueryOperator(
    ...
    use_legacy_sql = False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_genres.sql').read().replace("\n"," "),
...
create_movies_fav_by_genre = BigQueryOperator(
    ...
    use_legacy_sql = False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_most_fav_by_genre.sql').read().replace("\n"," "),
...
create_movies_fav_per_year = BigQueryOperator(
    ...
    use_legacy_sql=False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_most_fav_per_year.sql').read().replace("\n"," "),
...
create_popular_movies_by_genre = BigQueryOperator(
    ...
    use_legacy_sql=False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_popular_movie_by_genre.sql').read().replace("\n"," "),
...
create_popular_movies_per_year = BigQueryOperator(
    ...
    use_legacy_sql=False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_popular_released_per_year.sql').read().replace("\n"," "),
    destination_dataset_table=f'{project_id}.{bq_dataset}.movies_popular_released_per_year',
    write_disposition='WRITE_TRUNCATE',
    create_disposition='CREATE_IF_NEEDED',
    bigquery_conn_id='bigquery_default'
)
...
create_movies_production_countries = BigQueryOperator(
    ...
    use_legacy_sql=False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_production_countries.sql').read().replace("\n"," "),
...
create_movies_spoken_languages = BigQueryOperator(
    ...
    use_legacy_sql=False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_movies_spoken_languages.sql').read().replace("\n"," "),
...
create_production_companies_portofolio = BigQueryOperator(
    ...
    use_legacy_sql=False,
    location='asia-southeast2',
    sql=open(f'{airflow_home}/sql/create_production_companies_portofolio.sql').read().replace("\n"," "),
